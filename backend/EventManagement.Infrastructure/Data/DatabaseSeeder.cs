...
public class DatabaseSeeder(EventManagementDbContext context) : IDatabaseSeeder
{
    ...
    async Task SeedParticipantsAsync()
    {
        if (await context.Participants.AnyAsync()) return;
    ...
    {
        int tableExists = await context.Database.ExecuteSqlRawAsync(@"
                SELECT EXISTS (
        ...
        {
            new() { Name = "John Doe", Email = "john@email.com", PasswordHash = "temp1" },
            new() { Name = "Jane Smith", Email = "jane.smith@email.com", PasswordHash = "temp2" },
            new() { Name = "Mike Johnson", Email = "mike.johnson@email.com", PasswordHash = "temp3" },
            new() { Name = "Sarah Wilson", Email = "sarah.wilson@email.com", PasswordHash = "temp4" },
            new() { Name = "David Brown", Email = "david.brown@email.com", PasswordHash = "temp5" },
            new() { Name = "Lisa Davis", Email = "lisa.davis@email.com", PasswordHash = "temp6" },
            new() { Name = "Robert Miller", Email = "robert.miller@email.com", PasswordHash = "temp7" },
            new() { Name = "Emily Taylor", Email = "emily.taylor@email.com", PasswordHash = "temp8" },
            new() { Name = "Thomas Anderson", Email = "thomas.anderson@email.com", PasswordHash = "temp9" },
            new() { Name = "Jennifer Martinez", Email = "jennifer.martinez@email.com", PasswordHash = "temp10" },
            new() { Name = "Christopher Lee", Email = "christopher.lee@email.com", PasswordHash = "temp11" },
            new() { Name = "Amanda White", Email = "amanda.white@email.com", PasswordHash = "temp12" },
            new() { Name = "Kevin Harris", Email = "kevin.harris@email.com", PasswordHash = "temp13" },
            new() { Name = "Michelle Clark", Email = "michelle.clark@email.com", PasswordHash = "temp14" },
            new() { Name = "Jason Lewis", Email = "jason.lewis@email.com", PasswordHash = "temp15" },
            new() { Name = "Stephanie Walker", Email = "stephanie.walker@email.com", PasswordHash = "temp16" },
            new() { Name = "Brian Hall", Email = "brian.hall@email.com", PasswordHash = "temp17" },
            new() { Name = "Rebecca Allen", Email = "rebecca.allen@email.com", PasswordHash = "temp18" },
            new() { Name = "Daniel Young", Email = "daniel.young@email.com", PasswordHash = "temp19" },
            new() { Name = "Nicole King", Email = "nicole.king@email.com", PasswordHash = "temp20" }
        };
    ...
    {
        _ = await context.Database.ExecuteSqlRawAsync("SELECT setval('\"events_Id_seq\"', (SELECT MAX(\"Id\") FROM events))");
        _ = await context.Database.ExecuteSqlRawAsync("SELECT setval('\"users_Id_seq\"', (SELECT MAX(\"Id\") FROM users))");
    }
}
